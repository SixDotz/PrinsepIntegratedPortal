                ...
                <div>
                    <h3>
                        ...
                        <%                                    
                            ...
                            eventDetails = user.getFullName() + " has "+status +" " + details.getLetsGoEvent().getTitle() + ".";
                        %>
                        <input type="hidden" id="hRsvpStatus" name="rsvpStatus" value="<%=StringEscapeUtils.escapeHtml4(rsvpStatus)%>"/>
