...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btnViewDetails").bind("click", function() {
            window.location = "${pageContext.request.contextPath}/LetsGoEventsDetails.action?LetsGo=";
        });
...
<div id="windNotify" style="text-align:center;">
    ...
    <button id="btnViewDetails" type="button" class="btn" align="right">Go To Outing Page</button>
</div>